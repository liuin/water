  ...
  <div class="main-box container">
    <div class="login-bk "><div class="row">
      ...
      <div class="col-md-5 col-lg-4 col-login" style="padding-top: 0;">
            <div class="lg-top-nav clearfix">
              <a href="#" data-target="zhuser-login-tag" class="zh-login active fl">我要注册</a>
            </div>
            <div class="tag-section-wrap">
              <div class="tag-reg zhuser-login-tag tag-section ">
                <form >
                 <div class="form-group clearfix" style="padding-bottom: 5px;">
                  <span class="glyphicon glyphicon-user" aria-hidden="true"></span>
                   <input type="text" class="form-control" id=""   placeholder="手机号注册">
...
<div class="form-group clearfix" style="padding-bottom: 5px;">
                 ...
                 <div class="form-sub-bk form-group">
                  ...
                  <textarea name="" readOnly class="form-xeiyu form-control">
...
用户参与大众点评网点评团团购时，还须同意及遵守点评团《团购用户协议》，并遵守相关团购规则。
...
1、本协议所称之大众点评网用户信息是指符合法律、法规及相关规定，并符合下述范围的信息：
...
（4）用户密码遗失的，可以通过注册电子邮箱发送的链接重置密码，以手机号码注册的用户可以凭借手机号码找回原密码。用户若发现任何非法使用用户名或存在其他安全漏洞的情况，应立即告知大众点评网。
...
12、用户有权根据点评团《团购用户协议》及相关团购规则，参加大众点评网团购；
...
大众点评网要求各搜索引擎遵循行业规范，即“拒绝 Robots 访问标准”(Robots Exclusion Standard)，否则将视你的抓取行为是对我网站财产权利和知识产权的侵犯，有权通过法律诉讼维护网站利益。大众点评网制定了详细的Robots规则，点击查阅。
...
大众点评网的向用户说明这些条款的义务将通过如下方式实现：而用户如有任何需要说明条款的要求，请立即停止注册或使用大众点评网，同时立即造访http://www.dianping.com/contactus以致电说明，个人用户请拨打400 820 5527(工作时间：周一至周日8:00-21:00)，商家用户请拨打400 880 5597 (工作时间：周一至周日9:00-21:00)；若用户未致电至大众点评网而选择同意该协议，则双方在此确认大众点评网已依法履行了根据用户要求对相关条款进行说明的法定义务，大众点评网已给予用户充足的时间与充分的选择权来决定是否缔结本合同。
...
鉴于大众点评网已依法明确了上述条款、履行了格式条款制订方的义务，用户点击立即注册或使用大众点评网各项服务，将被视为且应当被视为用户已经完全注意并同意了本合同所有条款尤其是提醒用户注意的条款的合法性及有效性，用户不应当以大众点评网未对格式条款以合理方式提醒用户注意或未根据用户要求尽到说明义务为理由而声称或要求法院或其它任何第三方确认相关条款非法或无效。
                   ...
                   <label class="ipsy"><input type="checkbox" checked="checked">同意水汇网《用户使用协议》</label>
                   <a href="login.php" class="no-zh" >我有账号</a>
                 </div>
