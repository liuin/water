<?php $page='身边团购'; include('inc/header.php'); ?>
  <div class="main-box container">
    ...
    <div class="bannertuan box1">
      <div class="row ">
        <div class="col-sm-5 col-1">
          在地图上<span class="sp1">选择位置</span>,查看<span class="sp1">附近美团</span>
        </div>
        <div class="col-sm-7 col-2">
           <p>下载手机版，随时随地查看身边团购</p>
           <a href="" class="btn btn-info"><span class="glyphicon glyphicon-phone" aria-hidden="true"></span>苹果下载</a>
           <a href="" class="btn btn-info"><span class="glyphicon glyphicon-phone" aria-hidden="true"></span>安卓下载</a>
           <img src="http://www.fxauto.com.cn/images/ydgw-code2.jpg" class="code" alt="">
        </div>
      </div>
    </div>

    <div class="map-buyteam-bk">
      <div class="title1">身边团购</div>
      <div class="box1">
        <div class="row">
          <div class="col-sm-4 col-1">
            <p class="pos-wb">我的位置</p>
...
+(function($){
  $(document).ready(function() {    
    ...
    //创建地图函数：
    function createMap(){
        var map = new BMap.Map("bd-map");//在百度地图容器中创建一个地图
