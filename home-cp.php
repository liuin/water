<? $page='首页'; include('inc/header.php') ?>
    ...
    <div class="row">
      <div class="col-md-3 left-side">
        <div class="row">
          ...
          <div class="td-order col-box   col-md-12">
            <h2 class="hd title1"><span class="glyphicon glyphicon-bookmark"></span>团队预定</h2>
            <div class="box1">
              <p class="p1">10文字</p> 
              <p class="p1">10文字</p> 
              <p class="p2">10文字</p> 
              <p class="p2">10文字</p> 
              <p class="p3">客服: 1234567</p> 
              <p class="p3">客服: 123456</p>
            </div>
          </div>
        </div>
      </div>
      <div class="col-md-9 right-side">
        ...
        <div class="zztj">
          <div class="title1"><span class="glyphicon glyphicon-fire"></span>站长推荐</div>
            <div class="box1">
              <div class="row row-1">
                <div class="col-sm-2 col-img">
                  <img src="http://mall.bydauto.com.cn/media/wysiwyg/20150716/237X255.jpg" width="120" height="150" alt="">  
                </div>
                
                  <div class="col-sm-7 col-msg" >
                  ...
                  <div class="col-sm-2 col-btn">
                    <div class="row">
                      <div class="col-xs-4 col-sm-12">
                        <a href="#"  class="link btn btn-primary">进入官网</a>
                      </div>
                      <div class="col-xs-4 col-sm-12">
                        <a href="#"  class="btn btn-info">立即抢购</a>
                      </div>
                      <div class="col-xs-4 col-sm-12">
                        <a href="#"  class="btn btn-warning">在线预定</a>
                      </div>
                    </div>
                  </div>
              </div>
  ...
  <div class="tj-box container">
    ...
    <div class="row">
      ...
      <div class="view-more-link col-xs-12">
        <a href="#"  class="">查看全部</a>
      </div>
    </div>
    </div>
